...
% Minotaur internals
\node (slicer)     at (2, -3) {Cut extraction\\(Slicer)};
\node [fill=blue!50] (canon)      at (2, -5) {Canonicalization\\(Canonicalizer)};
\node [fill=blue!50] (deCanon)    at (8, -3) {De-Canonicalization\\(Canonicalizer)};
\node (cache)      at (5, -5) {Cache};
\node (computeOpt) at (11, -5) {Compute\\Optimization};
